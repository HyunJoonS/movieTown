                            ...
                            <div className="detail">
                                ...
                                <div className="detail-info">
                                    <div className="inner-info">
                                        <dl><dt>개봉</dt><dd>{movie.release_dates.results.length>0?movie.release_dates.results[release_dates()].release_dates[0].release_date.substring(0, 10):'정보없음'}</dd></dl>
                                        <dl><dt>장르</dt><dd>{movie.genres.length>0?movie.genres.map((data) => { return (data.name) }).join():'장르미정'}</dd></dl>
                                        <dl><dt>국가</dt><dd>{movie.original_language}</dd></dl>
                                        <dl><dt>러닝타임</dt><dd>{movie.runtime?movie.runtime+'분':'정보없음'}</dd></dl>
                                        <dl><dt>등급</dt><dd>{movie.release_dates.results.length>0?movie.release_dates.results[release_dates()].release_dates[0].certification+'세 이용가':'정보없음'}</dd></dl>
